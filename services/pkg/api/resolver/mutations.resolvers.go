...
func (r *mutationResolver) Dispatch(ctx context.Context, gameID string, actions []string, authorization string, nonce int, optimistic bool) (*model.ActionTransaction, error) {
	game := r.Indexer.GetGame(gameID)
	if game == nil {
